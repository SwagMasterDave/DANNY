...
class Reason_Box(QGroupBox):
    def __init__(self):
        super().__init__("Allabeler First Session")
        ...
        for index, images in enumerate(self.csv_data):
            self.imageList.append(["ID",self.csv_data[index][0],self.csv_data[index][1],"your Label","your Label2",self.csv_data[index][2],0,"Y/N",1,"Y/N",1,"Y/N",1,"Y/N",1,self.csv_data[index][3],"First","total percentage","confidence level"])
    ...
    def show_table_popup(self):
        ...
        for row, data in enumerate(self.imageList):
            ...
            table_widget.verticalHeader().setDefaultSectionSize(301)  # Adjust the height as needed
            ...
            table_widget.setColumnWidth(2, 301)  # Adjust the width as needed for the image column
